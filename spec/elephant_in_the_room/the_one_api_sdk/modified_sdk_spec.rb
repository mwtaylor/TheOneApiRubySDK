...
RSpec.describe ElephantInTheRoom::TheOneApiSdk::ModifiedSdk do
  ...
  it "can chain modifiers" do
    ...
    exponential_backoff = ElephantInTheRoom::TheOneApiSdk::RetryStrategy::ExponentialBackoff.new(2)
    allow(exponential_backoff).to receive(:sleep)
    sdk = ElephantInTheRoom::TheOneApiSdk::TheOne.new("")
